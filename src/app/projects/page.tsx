...
const projects = [
    {
        title: 'Building an AI Voice Assistant',
        description:
            'A learning project series on building a voice assistant using the Web Speech API and the OpenAI API. Published by Manning Publications.',
        image: '/images/projects/BuildinganAIVoiceAssistant.png',
        tags: ['AI', 'JavaScript', 'Svelte'],
        link: 'https://shortener.manning.com/pZOG'
    },
    {
        title: 'Web API Demos',
        description:
    ...
    },
    {
        ...
        description:
            'A guided project series on building a basic toast notification system in a Svelte application. Published by Educative.',
