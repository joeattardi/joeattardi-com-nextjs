...
export default async function Page({ params }: { params: Promise<{ slug: string }> }) {
    ...
    return (
        <div className="flex flex-col gap-8 items-center w-[90vw] md:max-w-prose mx-auto">
            {post.data.image &&<img src={post.data.image} alt={post.data.title} className="rounded-xl shadow-lg" />}
            ...
            <div className="text-zinc-600 italic self-start">Joe Attardi</div>
